...
if(id){
  ...
  // Filter locations based on selected Emirates
        ...
        .then((res) => {
          if (res?.status === "success") {
            ...
            // });
              ...
              navigate("/dynamicpricing/monthly-coupon-code")
    ...
    <Container fluid className="py-4">
          ...
          <Row className="align-items-center">
            <Col xs={12} md={6}>
              <h4 className="mb-0 fw-bold text-primary">
                {id ? "Edit Monthly Coupon Code" : "Create Monthly Coupon Code"}
              </h4>
              <small className="text-muted">
                {id ? "Update the monthly coupon details below" : "Fill in the details to create a new monthly discount coupon"}
              </small>
            </Col>
            <Col xs={12} md={6} className="d-flex justify-content-md-end gap-2 mt-3 mt-md-0">
              <Link to="/dynamicpricing/monthly-coupon-code" className="text-decoration-none">
                <Button 
                  variant="light"
                  className="border"
                  style={{ 
      ...
      {editLoading ? (
        ...
        >
              ...
              <Row>
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="discount_type">
                    <Form.Label className="fw-medium">Discount Type <span className="text-danger">*</span></Form.Label>
                    <Form.Select
                      name="discount_type"
          ...
          {/* Validity & Rate Section */}
          <Card className="mb-4 border-0 shadow-sm">
            <Card.Header className="bg-light border-0 py-3">
              <h6 className="mb-0 fw-semibold">Validity Period & Rate</h6>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col xs={12} md={6} lg={3} className="mb-3">
...
export default CreateMonthlyCouponCode;
