...
const getPriceList =()=>{
  // return new Promise((resolve, reject)=>{
    ...
    const url = `${configWeb.GET_MONTHLY_PRICE}?${params.toString()}`;
...
const handlePageSizeChange = (newPageSize) => {
  ...
  <tr>
    ...
    <th scope="col">GPS</th>
    <th width="200px" >Extra 1000 KM Rate</th>
   
    <th width="200px" >Extra 2000 KM Rate</th>
   
    <th scope="col">Extra 3000 KM Rate</th>
